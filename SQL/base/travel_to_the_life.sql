...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 20 2018 г., 09:41
...
--
CREATE DATABASE IF NOT EXISTS `travel_to_the_life` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `travel_to_the_life`;
...
(178, 0, 'config', 'config_email', 'max.usikov@gmail.com', 0),
...
(1, 1, 'admin', '0925ccf15911a2a987f315ac8b9c8ee2c67e2b60', 'CVvcBbIg9', 'John', 'Doe', 'max.usikov@gmail.com', '', '', '', 1, '2018-12-20 10:30:10');
