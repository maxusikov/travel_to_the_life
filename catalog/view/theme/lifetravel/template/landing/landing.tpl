...
Первый этап программы «Путёвка в жизнь» стал победителем конкурса Фонда президентских грантов и проводится во Владимирской области с 21.11.2018 по 31.03.2018.
                        ...
                        <ul class="slides-container">
                            ...
                            <li class="item slide level level-2">
                                ...
                                <span class="detailed-text">
                                    До 20.01.2019 включительно зарегистрировавшиеся Участники Первого этапа программы «Путевка в жизнь» выполняют творческое задание – письменно излагают свое видение  короткометражного документального фильма о Владимирскаяой области. Участникам нужно написать, каким они видят фильм и как хотели бы его снять, какие сюжеты, места или люди войдут в этот фильм, какую музыку предполагают использовать в фильме и т.д.  
                                    Участники отправляют работы через <a href="<?php echo $personal_account; ?>" class="personal-account-link">Личный кабинет</a> и ожидают оценку <a href="#expert-jury" class="expert-jury-link">Жюри</a>.
    ...
    По итогам конкурса 500 лучших Участников будут приглашены на Второй этап программы
                            ...
                            <li class="item slide level level-5">
                                ...
                                <a class="detailed-link" onclick="javascript:$(this).closest('.level').find('.detailed-text').toggleClass('active');">Подробнее...</a>
                                <span class="detailed-text">Участники, прошедшие в финальный Четвертый этап Программы, будут приглашены на Санкт-Петербургский международный кинофестиваль «Мировой», где пройдут 8-дневный обучающий курс-интенсив и                                      
            ...
            <ul class="session-location-points">
                <li class="session-point">
                    ...
                    <div class="locations">
                        ...
                        <div class="photo">
                            <img src="/catalog/view/theme/lifetravel/image/theme_images/address_map_2.png" alt="ГТК «Суздаль»" title="ГТК «Суздаль»" />
                        </div>
                    </div>
                </li>
            </ul>
